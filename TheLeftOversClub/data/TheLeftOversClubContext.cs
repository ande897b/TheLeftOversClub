...
namespace TheLeftOversClub.Data
{
    public static class DbInitializer
    {

        public class TheLeftOversClubContext : DbContext
        {
            public TheLeftOversClubContext(DbContextOptions<TheLeftOversClubContext> options)
                : base(options)
            {
            }
        ...
        //       public static void Initialize(TheLeftOversClubContext context)
        //       {
